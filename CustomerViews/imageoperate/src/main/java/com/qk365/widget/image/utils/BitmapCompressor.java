package com.qk365.widget.image.utils;
...
//		Log.i(test,压缩后大小 + baos.toByteArray().length);
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options,
        ...
        Log.i("xwk", "原尺寸: " + picwidth + "* " + picheight);
        ...
        Log.i("xwk", "最终压缩比例:" + inSampleSize + "倍");
        Log.i("xwk", "新尺寸:" + targetwidth + "*" + targetheight);
        return inSampleSize;
    }
}
