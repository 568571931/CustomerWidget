...
public class ActionSheet {
    ...
    public static class Builder {
        ...
        public ActionSheet show() {
            ...
            //创建View,设置监听器等
            View view = LayoutInflater.from(mContext).inflate(R.layout.dialog_actionsheet, null);
...
//                        scrollLayout.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, scrollLayoutHeight));
                        scrollLayout.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                                ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        private int getPx(int i) {
            return (int) (i * mContext.getResources().getDisplayMetrics().density + 0.5f);//10dp的padding转换成px
